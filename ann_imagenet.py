...
#            if not args.dont_save:
        ...
        f.write(' test_loss: {:.4f}, test_acc: {:.4f}, best: {:.4f}'.  format(
            losses.avg, 
            top1.avg,
            max_accuracy
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',                default='IMAGENET',          type=str,       help='dataset name', choices=['MNIST','CIFAR10','CIFAR100'])
    ...
    parser.add_argument('--epochs',                 default=101,                type=int,       help='number of training epochs')
    ...
    parser.add_argument('--devices',                default='1',                type=str,       help='list of gpu device(s)')
...
#    os.environ['CUDA_VISIBLE_DEVICES'] = args.devices
    ...
    identifier = 'ann_'+architecture.lower()+'_'+dataset.lower()+'_bs128'
...
#        f=sys.stdout
    ...
    #if resume from pretrained model, load it
    pretrained_ann  = './trained_models/'+'ann_vgg16_imagenet_bs128_initlr.01_trainedtillepoch6_acc43.pth'
