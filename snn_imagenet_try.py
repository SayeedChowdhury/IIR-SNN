...
from vgg_spiking_mem_new import *
...
def test(epoch):
    ...
    with torch.no_grad():
        ...
        f.write(' test_loss: {:.4f}, test_acc: {:.4f}, best: {:.4f} '
            .format(
            losses.avg, 
            top1.avg,
            max_accuracy,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',                default='IMAGENET',          type=str,       help='dataset name', choices=['MNIST','CIFAR10','CIFAR100','IMAGENET'])
    ...
    parser.add_argument('-lr','--learning_rate',    default=2e-5,               type=float,     help='initial learning_rate')
    ...
    parser.add_argument('--timesteps',              default=1,                 type=int,       help='simulation timesteps')
    ...
    parser.add_argument('--weight_decay',           default=0,               type=float,     help='weight decay parameter for the optimizer')
    ...
    parser.add_argument('--train_acc_batches',      default=128,               type=int,       help='print training progress after this many batches')
    parser.add_argument('--devices',                default='0 1 2 3',                type=str,       help='list of gpu device(s)')
    ...
    try:
        ...
        pass 
    identifier = 'snn_'+architecture.lower()+'_'+dataset.lower()+'_'+str(timesteps)+'_bs'+str(batch_size)+'_'+'drop_.2_Adam_90p_tst1resume_jointbp_every8_lr2e-5'
...
#        f = sys.stdout
    ...
    #if converting from ann, load pretrained_ann   
#    pretrained_ann='./trained_models/ann_imagenet.pth'
    #else if not pretrained_ann starting from a previous trained snn file:
    pretrained_snn = './trained_models/snn_vgg16_imagenet_tst1_bs16_drop_.2_Adam_90p_inittst3_jointbp_every8.pth'
...
#        else:
        ...
        # if required, find the Vth
        thresholds = find_threshold(batch_size=64, timesteps=500, architecture=architecture)
        
        #if Vth is already saved from prior runs, load them
#        thresholds = [0.8821316361427307, 1.6592042446136475, 0.6565735340118408, 0.9715588688850403, 0.5347663760185242, 1.0482151508331299, 0.7605999112129211, 0.3263542950153351, 0.3537454605102539, 0.03553765267133713, 0.24042034149169922, 0.550839900970459, 0.1744481325149536, 0.6279454231262207, 0.3904576301574707]
