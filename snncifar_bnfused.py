...
from vgg_spiking_bnfused_biasyes import *
...
#the below function calculated layerwise Vth while ANN-SNN conversion
...
#            except OSError:
#                pass 
            filename = '/home/CHECKPOINTS/'+identifier+'.pth'
...
if __name__ == '__main__':
    ...
    try:
        ...
        pass 
    identifier = 'snn_'+architecture.lower()+'_'+dataset.lower()+'_tst'+str(timesteps)+'_'+'inittst3_90p_bnfused_biasconv'
...
#        f = sys.stdout
    ...
    if not pretrained_ann:
        #if we want to start training for lower tsep from higher tstep SNN, then uncomment following, load appropriate SNN file
        snn_file = '/home/CHECKPOINTS/'+'snn_vgg16_cifar10_tst3_inittst5_90p_bnfused_biasconv_thadj.pth'
        pretrained_snn = snn_file
        
        #if we want to start training in SNN domain with T=5, use following to load ANN file
#        pretrained_ann='/home/ann_vgg16_cifar10_bn_fused.pth'
#        pretrained_ann='./trained_models/ann_vgg5_cifar10_bn_fused.pth'
    ...
    if pretrained_ann:
        ...
        thresholds = find_threshold(batch_size=512, timesteps=500, architecture=architecture, thp=thp)
       
#        thresholds =[0.14336544275283813, 0.6218661069869995, 0.4619326591491699, 1.0052757263183594, 0.6241618394851685, 0.9337080717086792, 1.0685415267944336, 0.5010842084884644, 0.5620927214622498, 0.42685794830322266, 0.5085636377334595, 0.2720877528190613, 2.2533674240112305, 1.0530802011489868, 1.6152044534683228]
