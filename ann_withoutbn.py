...
#                pass
            ...
            filename = '/home/nano01/a/chowdh23/vgg9_snn_surrgrad_backprop/CHECKPOINTS/'+identifier+'.pth'
...
if __name__ == '__main__':
    ...
    identifier = 'ann_'+architecture.lower()+'_'+dataset.lower()+'_bs64_sgd_drop.2_lr.01_.5red_bn'
...
#        f=sys.stdout
    ...
    #pretrained_ann  = './trained_models/'+'ann_vgg16_cifar10.pth'
